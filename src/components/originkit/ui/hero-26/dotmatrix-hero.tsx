...
export function DotmatrixHero({
  badge = "CHROME EXTENSION MANIFEST V3 • 100% ON-DEVICE",
  titleLine1 = "Capture anything.",
  titleLine2 = "Make it clear.",
  description = "GoFully is a powerful browser extension for capturing webpages, extracting text, annotating screenshots, protecting sensitive information, and exporting polished results — all from your browser.",
    ...
    <section className="ok-h26-hero">
      <nav className="ok-h26-nav">
        ...
        <div className="ok-h26-nav-links">
          ...
          <a className="ok-h26-nav-pill" href="#features">
            Features
          </a>
          <a className="ok-h26-nav-pill" href="/security">
            Security
          </a>
          <a className="ok-h26-nav-pill" href="/support">
            Support
          </a>
          <a className="ok-h26-nav-pill" href="/faq">
            FAQ
          </a>
          <a className="ok-h26-nav-pill ok-h26-nav-pill--cta" href="https://chromewebstore.google.com/detail/gofully-full-page-screens/akfbmhmdlbmljklgajkgoekobofhhofc" target="_blank" rel="noreferrer">
        ...
        <div className="ok-h26-hero-inner">
          <div className="ok-h26-hero-content">
            ...
            <div className="ok-h26-cta-row">
              <a className="ok-h26-btn ok-h26-btn--white" href="https://chromewebstore.google.com/detail/gofully-full-page-screens/akfbmhmdlbmljklgajkgoekobofhhofc" target="_blank" rel="noreferrer">
                <span className="ok-h26-btn__label">{primaryCtaLabel}</span>
                <span className="ok-h26-btn__icon">
                  <img src={asset("arrow-right-1.svg")} alt="" />
                </span>
              </a>
              <a className="ok-h26-btn ok-h26-btn--blue" href="#features">
