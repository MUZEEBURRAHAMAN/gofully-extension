    ...
    <div className="min-h-screen bg-[#070b14] text-slate-100 flex flex-col justify-between">
      ...
      <main className="mx-auto w-full max-w-6xl px-6 py-20 lg:px-8 flex-1">
        <div className="text-center max-w-3xl mx-auto">
          <span className="inline-block bg-[#000] border border-slate-700 px-3.5 py-1 text-xs font-mono font-bold uppercase tracking-wider text-emerald-400">
        ...
        <div className="mt-16 space-y-8">
          <div className="border border-slate-800 bg-[#0d1424] p-8 lg:p-10">
            <h3 className="text-lg font-bold text-white flex items-center gap-3">
              <span className="flex h-8 w-8 items-center justify-center border border-emerald-500/40 bg-emerald-500/10 text-emerald-400 font-mono text-xs font-bold">01</span>
          ...
          <div className="border border-slate-800 bg-[#0d1424] p-8 lg:p-10">
            <h3 className="text-lg font-bold text-white flex items-center gap-3">
              <span className="flex h-8 w-8 items-center justify-center border border-emerald-500/40 bg-emerald-500/10 text-emerald-400 font-mono text-xs font-bold">02</span>
          ...
          <div className="border border-slate-800 bg-[#0d1424] p-8 lg:p-10">
            <h3 className="text-lg font-bold text-white flex items-center gap-3">
              <span className="flex h-8 w-8 items-center justify-center border border-emerald-500/40 bg-emerald-500/10 text-emerald-400 font-mono text-xs font-bold">03</span>
